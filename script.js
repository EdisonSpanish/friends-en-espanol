const temporadas = [
    ...
    },
    {
        ...
        preguntas: [
            ...
            { 
                ...
                alternativas: ["Quién está embarazada", "Quién está enamorada de Ross", "Quién quiere viajar"] 
            },
            { 
 ...
 {
            "texto": "En la tercera temporada, Ross y Rachel comienzan a salir, pero su relación termina poco después. Chandler enfrenta problemas con su novia Janice. Monica cambia de trabajo y Joey continúa con su carrera como actor.",
            "preguntas": [
                { "pregunta": "¿Quiénes comienzan a salir?", "respuesta": "Ross y Rachel", "alternativas": ["Monica y Chandler", "Ross y Rachel", "Joey y Phoebe"] },
                { "pregunta": "¿Con quién tiene problemas Chandler?", "respuesta": "su novia Janice", "alternativas": ["su jefe", "su novia Janice", "su perro"] },
        ...
        {
            "texto": "En la cuarta temporada, Ross se compromete con Emily. Chandler y Joey tienen problemas con su apartamento. Rachel se da cuenta de que todavía ama a Ross.",
            "preguntas": [
        ...
        },
 {
    ...
    {
        "texto": "En la séptima temporada, Chandler y Monica se comprometen y comienzan a planear su boda. Ross y Rachel siguen siendo amigos. Joey consigue un papel en una película famosa, impulsando su carrera.",
        "preguntas": [
    ...
    {
        "texto": "En la octava temporada, Rachel descubre que está embarazada, lo que sorprende a todos. Joey se enamora de ella y enfrenta sentimientos confusos. Mientras tanto, Monica y Chandler intentan tener un bebé, pero comienzan a tener dificultades.",
        "preguntas": [
    ...
    },
    {
        ...
        "preguntas": [
            ...
            { "pregunta": "¿A quién adoptan Monica y Chandler?", "respuesta": "gemelos", "alternativas": ["un perro", "gemelos", "un gato"] },
